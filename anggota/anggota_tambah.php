	...
	<div class="container col-md-6 mt-4">
  	...
  	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  		...
  		$msg = "Failed to upload image";
					...
					$datas = mysqli_query($db, "insert into member (id, name,tanggalLahir,email,username,jeniskelamin,image, image_text)values('$id', '$name', '$tanggalLahir', '$email', '$username', '$jeniskelamin', '$image', '$image_text')") or die(mysqli_error($db));
